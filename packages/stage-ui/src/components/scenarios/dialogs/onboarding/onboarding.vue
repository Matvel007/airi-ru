...
const popularProviders = computed(() => {
  const popular = ['openai', 'azure-openai', 'anthropic', 'amazon-bedrock', 'google-generative-ai', 'groq', 'nvidia', 'openrouter-ai', 'routerai', 'aitunnel', 'ollama', 'deepseek', 'player2', 'openai-compatible']
